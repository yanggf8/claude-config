...
sd () {
	...
	if [ -z "$search_term" ]
	then
		dirs=("${(@f)$(find . -maxdepth 1 -type d | sort -r)}") 
	else
		dirs=("${(@f)$(find . -type d -iname "*${search_term}*" | awk '{ print length, $0 }' | sort -n | cut -d' ' -f2-)}") 
	fi
	if [ ${#dirs[@]} -eq 0 ]
	then
	...
	echo -n "Enter the number of the directory to navigate to (Enter for 1, q to quit): "
	read choice
	if [[ "$choice" == "q" || "$choice" == "Q" ]]
	then
		echo "Exiting directory navigation."
		return 0
	fi
	if [ -z "$choice" ]
	then
	...
	if [[ "$choice" =~ ^[0-9]+$ ]] && [ "$choice" -ge 1 ] && [ "$choice" -le ${#dirs[@]} ]
	then
		...
		then
			...
			echo "Error: Directory $selected_dir does not exist or is not accessible."
			return 1
		fi
	else
...
alias -- 9='cd -9'
alias -- _='sudo '
alias -- claude=/home/yanggf/.claude/local/claude
alias -- egrep='grep -E'
alias -- fgrep='grep -F'
alias -- g=git
alias -- ga='git add'
...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/yanggf/.claude/local/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH='/home/yanggf/.pyenv/shims:/home/yanggf/.pyenv/bin:/home/yanggf/.nvm/versions/node/v23.11.1/bin:/home/yanggf/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/usr/lib/wsl/lib:/mnt/c/Program Files/Eclipse Adoptium/jdk-11.0.14.101-hotspot/bin:/mnt/c/Program Files (x86)/Common Files/Oracle/Java/javapath3:/mnt/c/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.0/libnvvp:/mnt/c/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.0/bin/:/mnt/c/Program Files/Common Files/Microsoft Shared/Windows Live:/mnt/c/Program Files (x86)/Common Files/Microsoft Shared/Windows Live:/mnt/c/Program Files (x86)/NVIDIA Corporation/PhysX/Common:/mnt/c/Program Files (x86)/Intel/iCLS Client/:/mnt/c/Program Files/Intel/iCLS Client/:/mnt/c/WINDOWS/system32:/mnt/c/WINDOWS:/mnt/c/WINDOWS/System32/Wbem:/mnt/c/WINDOWS/System32/WindowsPowerShell/v1.0/:/mnt/c/Program Files (x86)/Intel/OpenCL SDK/2.0/bin/x86:/mnt/c/Program Files (x86)/Intel/OpenCL SDK/2.0/bin/x64:/mnt/c/Program Files/Intel/Intel(R) Management Engine Components/DAL:/mnt/c/Program Files/Intel/Intel(R) Management Engine Components/IPT:/mnt/c/Program Files (x86)/Intel/Intel(R) Management Engine Components/DAL:/mnt/c/Program Files (x86)/Intel/Intel(R) Management Engine Components/IPT:/mnt/c/Program Files (x86)/Windows Live/Shared:/mnt/c/Program Files (x86)/GtkSharp/2.12/bin:/mnt/c/Program Files (x86)/AresPKIComponent-Java/AresPKI:/mnt/c/Users/yanggf/.dnx/bin:/mnt/c/Program Files/Microsoft DNX/Dnvm/:/mnt/c/Program Files/PuTTY/:/mnt/c/WINDOWS/System32/OpenSSH/:/mnt/c/Program Files/Microsoft VS Code/bin:/mnt/c/ProgramData/chocolatey/bin:/mnt/c/WINDOWS/system32:/mnt/c/WINDOWS:/mnt/c/WINDOWS/System32/Wbem:/mnt/c/WINDOWS/System32/WindowsPowerShell/v1.0/:/mnt/c/WINDOWS/System32/OpenSSH/:/mnt/c/Program Files/dotnet/:/mnt/c/Program Files/Git/cmd:/mnt/c/Program Files (x86)/Common Files/DivX11 Shared/DesktopService:/mnt/c/Program Files/NVIDIA Corporation/NVIDIA app/NvDLISR:/mnt/c/Program Files/Docker/Docker/resources/bin:/mnt/c/Program Files/nodejs/:/mnt/c/Users/yanggf/AppData/Local/Programs/Python/Python311/Scripts/:/mnt/c/Users/yanggf/AppData/Local/Programs/Python/Python311/:/mnt/c/Users/yanggf/scoop/shims:/mnt/c/Program Files/Java/jdk1.6.0_45/bin:/mnt/c/Users/yanggf/AppData/Local/Microsoft/WindowsApps:/mnt/c/Users/yanggf/AppData/Local/Google/Cloud SDK/google-cloud-sdk/bin:/mnt/c/Program Files/MKVToolNix:/mnt/c/Users/yanggf/AppData/Local/JetBrains/Toolbox/scripts:/mnt/c/MinGW/bin:/mnt/c/Users/yanggf/AppData/Local/Microsoft/WindowsApps:/mnt/c/Users/yanggf/AppData/Roaming/npm:/home/yanggf/Android/sdk/cmdline-tools/bin:/home/yanggf/Android/sdk/platform-tools'
